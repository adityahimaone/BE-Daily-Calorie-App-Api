...
// AddFood provides a mock function with given fields: food
func (_m *Service) AddFood(food *foods.Domain) (*foods.Domain, error) {
	ret := _m.Called(food)
...
func (_m *Service) DeleteFood(id int) (string, error) {
	ret := _m.Called(id)
